...
class CoreAudioOutputDevice final : public IAudioOutputDevice {
 public:
 ...
 private:
  std::vector<AudioDeviceInfo> devices_{
      {"coreaudio-default", "CoreAudio Default Output", true},
      {"coreaudio-virtual-out", "CoreAudio Virtual Output", false},
  };
